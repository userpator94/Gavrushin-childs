    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < stroki.Length; i++)
            {
                ...
                if (datesBetween.Days < 2373 || datesBetween.Days > 6392)
                {
                    MessageBox.Show(
                        "Вероятно человек в " + i + 1 + " строчке либо старше 17, либо младше 7",
                        "Внимание",
                        MessageBoxButtons.OK,
                        MessageBoxIcon.Error);
                    return;
            ...
            MessageBox.Show("Данные внесены", "", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
